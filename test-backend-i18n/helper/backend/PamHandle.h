...
class PamBackend;
    ...
    */
    ...
    public:
        ...
        */
        explicit PamHandle(PamWorkState &ref,
                           PamBackend *parent);
        ...
        * \param loop if true continue pam_chauthtok in loop when max. limit of tries reached
        */
        void setMaxTriesLoop(bool loop);
    ...
    private:
        ...
        */
        ...
        bool m_maxtries_loop { true }; ///< whether to loop pam_chauthtok after maxtries return
    };
}
